...
public interface ProjectsApi {
    ...
    ResponseEntity<Void> projectsProjectIdActivePut(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
    ...
    @RequestMapping(value = "/projects/{project_id}/archive",
            produces = { "application/json" },
            method = RequestMethod.PUT)
    ResponseEntity<Void> projectsProjectIdArchivePut(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
            ,@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId
    ) throws APIException;
    ...
    ResponseEntity<Void> projectsProjectIdDelete(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
            ,@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId
    ) throws APIException;
    ...
    ResponseEntity<Project> projectsProjectIdGet(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
            ,@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId
    ) throws APIException;
    ...
    @RequestMapping(value = "/projects/{project_id}/groups",
            produces = { "application/json" },
            method = RequestMethod.GET)
    ResponseEntity<List<Group>> projectsProjectIdGroupsGet(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
            ,@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId
    ) throws APIException;
    ...
    @RequestMapping(value = "/projects/{project_id}/groups/{group_id}/invitation",
            produces = { "application/json" },
            method = RequestMethod.PUT)
    ResponseEntity<Void> projectsProjectIdGroupsGroupIdInvitationPut(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
            ,@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId
    ...
    @RequestMapping(value = "/projects/{project_id}/groups/{group_id}/members",
            produces = { "application/json" },
            method = RequestMethod.GET)
    ResponseEntity<List<Member>> projectsProjectIdGroupsGroupIdMembersGet(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
            ,@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId
    ...
    ResponseEntity<Void> projectsProjectIdGroupsGroupIdMembersPatch(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
            ,@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId
            ,@ApiParam(value = "group id",required=true) @PathVariable("group_id") String groupId
    ...
    @RequestMapping(value = "/projects/{project_id}/members/{member_id}",
            produces = { "application/json" },
            method = RequestMethod.DELETE)
    ResponseEntity<Void> projectsProjectIdMembersMemberIdDelete(@ApiParam(value = "user_id(not name)" ,required=true) @RequestHeader(value="X-User-Id", required=true) String xUserId
            ,@ApiParam(value = "project id",required=true) @PathVariable("project_id") String projectId
