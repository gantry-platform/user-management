...
public class UsersApiController implements UsersApi {
    ...
    public ResponseEntity<User> usersUserIdGet(@ApiParam(value = "user_id(not name)",required=true) @PathVariable("user_id") String userId
,@ApiParam(value = "프로젝트 정보까지 포함") @Valid @RequestParam(value = "project_info", required = false) Boolean projectInfo
    ...
    public ResponseEntity<Project> usersUserIdProjectsPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody NewProject body
